...
import InterestForm from './pages/InterestForm.vue'
...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/:lang(en|es)/interest', name: 'interest-form', component: InterestForm },
  { path: '/:lang(en|es)/contribute', name: 'contribute', component: Contribute },
